                ...
                <div className="addBasket">
                    ...
                    <div className="addBasket--block">
                        ...
                        <div className='addBasket--block__size'>
                            <div onClick={()=> {clearSize(); setM(true)}} style={{border: `2px solid ${M?"green":''}`, color: M?"green":''}}>{shoe === false?'M':'34'}</div>
                            <div onClick={()=> {clearSize(); setXL(true)}} style={{border: `2px solid ${XL?"green":''}`, color: XL?"green":''}}>{shoe === false?'XL':'35'}</div>
                            <div onClick={()=> {clearSize(); setXXL(true)}} style={{border: `2px solid ${XXL?"green":''}`, color: XXL?"green":''}}>{shoe === false?'XXL':'36'}</div>
                            <div onClick={()=> {clearSize(); setC(true)}} style={{border: `2px solid ${C?"green":''}`, color: C?"green":''}}>{shoe === false?'C':'37'}</div>
                            <div onClick={()=> {clearSize(); setS(true)}} style={{border: `2px solid ${S?"green":''}`, color: S?"green":''}}>{shoe === false?'S':'38'}</div>
                            <div onClick={()=> {clearSize(); setXS(true)}} style={{border: `2px solid ${XS?"green":''}`, color: XS?"green":''}}>{shoe === false?'XS':'39'}</div>
                        </div>
                        <h5 className="addBasket--block__col">Цвет: <span>{colorText()}</span></h5>
                        <div className='addBasket--block__color'>
                            <div onClick={()=> {clearColor(); setBlack(true)}} style={{border: `2px solid ${black?"green":''}`}} className='addBasket--block__color--one'></div>
                            <div onClick={()=> {clearColor(); setRed(true)}} style={{border: `2px solid ${red?"green":''}`}} className='addBasket--block__color--two'></div>
                            <div onClick={()=> {clearColor(); setGray(true)}} style={{border: `2px solid ${gray?"green":''}`}} className='addBasket--block__color--three'></div>
                            <div onClick={()=> {clearColor(); setBlue(true)}} style={{border: `2px solid ${blue?"green":''}`}} className='addBasket--block__color--fore'></div>
                        </div>

                        <div className='addBasket--block__btn'>
                            <NavLink className='addBasket--block__btn--link' to={!check?'':'/basket'}>
                                <button onClick={()=> {if (!check){addBtn()}}} style={{background: adding?'':'green', color: adding?'':'white'}}>{adding?check?'Перейти в корзину' :'Добавить в корзину':'Добавлено'}</button>
                            </NavLink>
